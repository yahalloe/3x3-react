...
export function MainContainer() {
  return (
    // <div className="bg-[#1a1a1a] border border-stone-700 rounded-2xl shadow-lg p-5 w-full max-w-[1100px] mx-auto">
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:grid-cols-3 md:gap-5 lg:gap-3 w-full max-w-[1000px] mx-auto p-2">
        ...
        <Link to="anime/edgerunner">
          <img
            title="Edgerunner"
            src="/edgerunner.gif"
            className="object-cover w-full aspect- rounded-2xl"
          />
        </Link>
        <Link to="anime/frieren">
          <img
            title="Frieren"
            src="/fern.png"
            className="object-cover w-full aspect- rounded-2xl w-[320px] h-[320px]"
          />
        </Link>
        ...
        <Link to="anime/86">
          <img
            title="86"
            src="/86-eighty-six-lena-shin-4k--78.0_d.jpg"
            className="object-cover w-full aspect- rounded-2xl"
          />
        </Link>
      </div>
