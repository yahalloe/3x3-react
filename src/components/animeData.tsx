...
export const animeList = [
  {
    ...
    reason: 
      <>          
        We can say that Hyouka is a masterpiece. Not only the animation is impeccable for it's time,
        the mysteries it presents, forshawdowing and the characters are top notch.
      </>
  },
  {
    id: "edgerunner",
    title: "Cyberpunk: Edgerunners",
    image: "/edgerunner.gif",
    description:
      "In the neon-lit streets of Night City, a young man tries to survive as a mercenary known as an edgerunner.",
    reason: 
      <>          
        It's the best show of 2022. Hands down.
      </>
  },
  {
    id: "frieren",
    title: "Frieren: Beyond Journey's End",
    image: "/frierenTrio.jpg",
    description:
  ...
  },
  {
    id: "86",
    title: "86: Eighty-Six",
    image: "/86-eighty-six-lena-shin-4k--78.0_d.jpg",
    description:
